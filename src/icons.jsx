...
const I = {
  ...
  notebook: (p) => <Icon {...p} d={<><path d="M7 3h11a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H7z"/><path d="M5 6h2M5 10h2M5 14h2M5 18h2"/><path d="M11 8h4M11 12h4"/></>} />,
  chat: (p) => <Icon {...p} d={<><path d="M21 15a2 2 0 0 1-2 2H8l-4 4V5a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2z"/><path d="M8 9h8M8 13h5"/></>} />,
  expand: (p) => <Icon {...p} d={<><path d="M15 3h6v6"/><path d="M9 21H3v-6"/><path d="M21 3l-7 7"/><path d="M3 21l7-7"/></>} />,
  collapse: (p) => <Icon {...p} d={<><path d="M4 14h6v6"/><path d="M20 10h-6V4"/><path d="M14 10l7-7"/><path d="M3 21l7-7"/></>} />,
  pin: (p) => <Icon {...p} d={<><path d="M12 17v5"/><path d="M9 10.8V4h6v6.8l2.5 3.2H6.5z"/></>} />,
  pinned: (p) => <Icon {...p} fill="currentColor" stroke="currentColor" d={<><path d="M9 4h6v6.8l2.5 3.2H6.5L9 10.8z"/><path d="M12 17v5" stroke="currentColor"/></>} />,
  ...
  keyboard: (p) => <Icon {...p} d={<><rect x="2" y="6" width="20" height="12" rx="2"/><path d="M6 10h.01M10 10h.01M14 10h.01M18 10h.01M6 14h.01M18 14h.01M9 14h6"/></>} />,
};

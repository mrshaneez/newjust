  ...
  staff: {
    ...
    fields: [
      ...
      { key: "role", label: "Role", kind: "select",
        options: ["Registrar", "Deputy Registrar", "Court Clerk", "IT Officer", "Bailiff", "Translator", "Security Officer", "Administrator"] },
      { key: "department", label: "Department", kind: "select",
        options: ["Registry", "Courtroom 1", "Courtroom 2", "Courtroom 3", "Technology", "Security", "Administration"] },

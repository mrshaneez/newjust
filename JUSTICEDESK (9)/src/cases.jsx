...
const CasesPage = ({ cases, setCases, viewCase, setViewCase, updateCase, setModal }) => {
  ...
  if (cs) return <CaseDetail cs={cs} cases={cases} updateCase={updateCase} setViewCase={setViewCase} setModal={setModal} activeTab={activeTab} setActiveTab={setActiveTab} canDelete={canDelete} deleteCase={deleteCase} />;
...
const CaseDetail = ({ cs, cases = [], updateCase, setViewCase, setModal, activeTab, setActiveTab, canDelete, deleteCase }) => {
